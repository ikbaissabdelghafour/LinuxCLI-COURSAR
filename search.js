const commands = [
    // File Management
    {id:'ls', name:'ls', desc:'عرض الملفات والمجلدات', url:'foldecli.html#ls'},
    {id:'ls-l', name:'ls -l', desc:'عرض الملفات بالتفاصيل', url:'foldecli.html#ls-l'},
    {id:'ls-a', name:'ls -a', desc:'عرض جميع الملفات حتى المخفية', url:'foldecli.html#ls-a'},
    {id:'cd', name:'cd', desc:'التنقل بين المجلدات', url:'foldecli.html#cd'},
    {id:'pwd', name:'pwd', desc:'عرض المسار الحالي', url:'foldecli.html#pwd'},
    {id:'mkdir', name:'mkdir', desc:'إنشاء مجلد جديد', url:'foldecli.html#mkdir'},
    {id:'rmdir', name:'rmdir', desc:'حذف مجلد فارغ', url:'foldecli.html#rmdir'},
    {id:'touch', name:'touch', desc:'إنشاء ملف فارغ أو تحديث تاريخ الملف', url:'foldecli.html#touch'},
    {id:'cp', name:'cp', desc:'نسخ الملفات والمجلدات', url:'foldecli.html#cp'},
    {id:'mv', name:'mv', desc:'نقل أو إعادة تسمية الملفات والمجلدات', url:'foldecli.html#mv'},
    {id:'rm', name:'rm', desc:'حذف الملفات والمجلدات', url:'foldecli.html#rm'},
    {id:'find', name:'find', desc:'البحث عن الملفات والمجلدات', url:'foldecli.html#find'},
    {id:'locate', name:'locate', desc:'البحث السريع باستعمال قاعدة البيانات', url:'foldecli.html#locate'},
